...
**Version Bump** ✅
- Bumped to v0.2.0 across all files
...
```
84153dd chore: bump version to v0.2.0
82a7dee docs: add v0.2.0 changelog entry for rebranding
...
- Announce v0.2.0 with rebranding notes
...
**Status**: ✅ Rebranding Complete - Ready for v0.2.0 Release
